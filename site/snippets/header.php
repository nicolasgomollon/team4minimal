...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/team4minimal/assets/stylesheets/style.css" />
	<link rel="stylesheet" type="text/css" href="/team4minimal/assets/stylesheets/style.mobile.css" media="all and (max-device-width: 480px)" />
	<meta name="viewport" content="width=device-width, initial-scale=1, minimum-scale=1, maximum-scale=1, user-scalable=no" />
	<!--[if IE]>
		<link rel="shortcut icon" href="/team4minimal/favicon.ico" />
		<link rel="stylesheet" type="text/css" href="/team4minimal/assets/stylesheets/style.ie.css" />
